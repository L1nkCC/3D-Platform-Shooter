...
public class MeshDestroy : MonoBehaviour
{
    ...
    public float MinimiumVolume = .1f;
    public float PieceDespawnTime = 9f;
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            //Volume Check
            if (MeshVolume.VolumeOfObject(this.GameObject) < original.MinimiumVolume)
            {
            ...
            meshDestroy.MinimiumVolume = original.MinimiumVolume;
            meshDestroy.PieceDespawnTime = original.PieceDespawnTime;

            Destroy(GameObject, original.PieceDespawnTime);
